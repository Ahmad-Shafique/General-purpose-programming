...
int game_beginning();
int student();
void Game_Over(){getch(); system("cls"); printf("\n\n\n\n\n\t\t\t\t\tGAME OVER\n"); exit(EXIT_SUCCESS);}//{cout<<setw(50)<<"GAME OVER"; return 0;}
void out_of_money();
...
{
    system("cls");
    printf("Age = %d Years %d months\n",(20 + player.time/2),player.time*6);
    printf("Money = %d\n",player.money);
...
void Execution_By_Orders_of_The_King()
{
    ...
    printf("You Die, but you become a martyr to the king's tyranny in the eyes of the people\n");
    Game_Over();
}
